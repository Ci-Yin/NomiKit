 ...
 */
internal fun GenerateProcessResponse.toImageResult(): ImageResult = ImageResult(
    images = images.map { encoded ->
        GeneratedImage(
...
internal fun ByteArray.toSdWebUiBase64(): String = Base64.Default.encode(this)
