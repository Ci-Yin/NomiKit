...
class SimpleMainKtsScriptDefinition : ScriptCompilationConfiguration(
    {
        ...
        jvm {
            val keyResource =
                SimpleMainKtsScriptDefinition::class.java.name.replace('.', '/') + ".class"
            val thisJarFile =
                SimpleMainKtsScriptDefinition::class.java.classLoader.getResource(keyResource)
...
class MainKtsConfigurator : RefineScriptCompilationConfigurationHandler {
    private val resolver =
        CompoundDependenciesResolver(FileSystemDependenciesResolver(), IvyResolver())
