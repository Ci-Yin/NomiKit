package ciyin.ai.facade.impl.image
 ...
 * [AiImage] 的默认实现。
 *
 * 职责与 [ciyin.ai.facade.impl.chat.DefaultAiChat] 对称：负责引擎选择、降级与观测，但不承担任何业务语义。
 *
...
class DefaultAiImage(
     ...
     * 解析一个备用生图引擎尝试。
     *
     * 与 [ciyin.ai.facade.impl.chat.DefaultAiChat.resolveBackupAttempt] 同理：备用引擎只保留请求上已有的模型名，
     * 不复用主引擎的显式模型覆盖。
     */
