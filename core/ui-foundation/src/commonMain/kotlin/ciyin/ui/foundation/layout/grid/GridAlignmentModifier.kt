...
internal class GridAlignmentElement(val alignment: Alignment) :
    ModifierNodeElement<GridAlignmentNode>() {
...
internal class GridAlignmentNode(var alignment: Alignment) : Modifier.Node(),
    ParentDataModifierNode {
    override fun Density.modifyParentData(parentData: Any?): Any {
        val p = parentData as? GridParentData
            ?: GridParentData()
