...
import ciyin.ui.foundation.widget.TabRowDefaults2.tabIndicatorOffset
...
fun ScrollableTabRow(
    ...
    edgePadding: Dp = TabRowDefaults2.ScrollableTabRowEdgeStartPadding,
    minTabWidth: Dp = ScrollableTabRowMinimumTabWidth,
    indicator: @Composable (tabPositions: List<TabPosition>) -> Unit =
        @Composable { tabPositions ->
            if (tabPositions.getOrNull(selectedTabIndex) != null) {
    ...
    fun Modifier.tabIndicatorOffset(
        ...
        composed(
            ...
            wrapContentSize(Alignment.BottomStart)
                .offset {
                    IntOffset(
                        x = (indicatorOffset + currentTabWidth / 2 - width / 2).roundToPx(),
                        y = 0
                    )
                }
                .size(width, height)
