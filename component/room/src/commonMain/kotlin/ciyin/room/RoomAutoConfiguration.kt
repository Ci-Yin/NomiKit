...
import ciyin.koin.configuration.KoinBootQualifiers
    ...
    module {
        ...
        onMissInstances<RoomDatabase.Builder<*>> {
            factory { parametersHolder ->
                ...
                get<Context>()
                    .createDatabaseBuilder(databaseClass, name + roomProperties.databaseSuffixName)
...
expect inline fun <reified T : RoomDatabase> Context.createDatabaseBuilder(
    databaseClass: KClass<T>,
    name: String
): RoomDatabase.Builder<T>

expect inline fun <reified T : RoomDatabase> Context.createInMemoryDatabaseBuilder(
    databaseClass: KClass<T>
): RoomDatabase.Builder<T>
...
inline fun <reified R : RoomDatabase, reified T> Module.singleDao(
    ...
    single<T>(qualifier) {
        val scope =
            this.getKoin().getOrCreateScope(
                R::class.qualifiedName.toString(),
                KoinBootQualifiers.RoomDatabaseScope
            )
