...
var KoinProperties.room_database_suffix_name: String
    get() = (this[RoomProperties.ROOM_DATABASE_SUFFIX_NAME] as String?)
        ?: RoomProperties().databaseSuffixName
    set(value) {
        RoomProperties.ROOM_DATABASE_SUFFIX_NAME(value)
    }

var KoinProperties.room_journal_mode: RoomDatabase.JournalMode
    get() = (this[RoomProperties.ROOM_JOURNAL_MODE] as RoomDatabase.JournalMode?)
        ?: RoomProperties().journalMode
    set(value) {
